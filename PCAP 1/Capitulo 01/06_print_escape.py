...
#
# 1. Se quiser colocar apenas uma barra invertida dentro de uma string, não se esqueça da sua natureza de escape - tem de a duplicar, 
# por exemplo, uma tal invocação causará um erro:
# 
# print("\")
#
