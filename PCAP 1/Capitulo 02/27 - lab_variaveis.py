...
# experimente com o seu código: crie novas variáveis, atribua-lhes valores diferentes e efetue várias operações aritméticas sobre elas (por exemplo, 
# +, -, -, *, /, //, etc.). Tente imprimir uma string e um inteiro juntos numa linha, por exemplo, "Total number of apples:" e total_apples.
