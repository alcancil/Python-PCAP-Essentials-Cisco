...
# string + string
#
# Simplesmente concatena (cola) duas strings numa. Claro que, tal como o seu irmão aritmético, pode ser usado mais de uma vez numa expressão, e em tal 
# contexto comporta-se de acordo com a ligação do lado esquerdo.
#
...
#
#
# Nota: usando + para concatenar strings permite construir o output de uma forma mais precisa do que com uma função pura print() , mesmo que enriquecida 
# com os end= e sep= argumentos de keyword.
