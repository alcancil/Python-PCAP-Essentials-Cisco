...
# Este código destina-se a imprimir a string "Inside the loop." e o valor armazenado na variável counter durante um determinado loop exatamente cinco 
# vezes. Uma vez que a condição não foi atendida (a variável counter atingiu 0), o loop é encerrado, e a mensagem "Outside the loop." bem como o valor # armazenado em counter é impresso.
#
...
# LEMBRE-SE
#
#Não se sinta obrigado a codificar os seus programas de uma forma que seja sempre a mais curta e a mais compacta. A legibilidade pode ser um fator 
# mais importante. Mantenha o seu código preparado para um novo programador.
