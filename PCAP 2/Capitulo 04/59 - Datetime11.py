...
#
# A segunda função chamada mktime converte um objeto struct_time ou um tuple que expressa a hora local para o número de segundos desde a época Unix. No nosso exemplo, passamos-lhe um tuple, que consiste nos 
# seguintes valores:
#
# 2019 => tm_year
# 11 => tm_mon
